...
import static com.copypaste.api.util.constant.Suppression.DEPRECATION;

/**
 * This Class is about the MultiBlock which takes care of pushing others around (In a non mean way).
 */
public class MultiBlock extends AbstractBlockCopyPaste<MultiBlock>
{
            ...
            final float hitZ)
    {
        if (worldIn.isRemote)
        {
            CopyPaste.proxy.openMultiBlockWindow(pos);
        }
        return true;
    }
