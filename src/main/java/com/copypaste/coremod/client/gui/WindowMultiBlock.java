...
import com.copypaste.blockout.Log;
import com.copypaste.blockout.Pane;
import com.copypaste.blockout.controls.ButtonImage;
import com.copypaste.blockout.controls.TextField;
import com.copypaste.blockout.views.View;
import com.copypaste.coremod.CopyPaste;
import com.copypaste.coremod.network.messages.MultiBlockChangeMessage;
import com.copypaste.coremod.tileentities.TileEntityMultiBlock;
...
import static com.copypaste.coremod.tileentities.TileEntityMultiBlock.DEFAULT_RANGE;
import static com.copypaste.coremod.tileentities.TileEntityMultiBlock.DEFAULT_SPEED;
...
public class WindowMultiBlock extends AbstractWindowSkeleton
{
    ...
    private void confirmClicked()
    {
        ...
        CopyPaste.getNetwork().sendToServer(new MultiBlockChangeMessage(pos, facing, output, range, speed));
        close();
    }
