...
import com.copypaste.blockout.controls.*;
import com.copypaste.blockout.views.ScrollingList;
import com.copypaste.blockout.views.Window;
import com.copypaste.coremod.CopyPaste;
import com.copypaste.coremod.network.messages.ReplaceBlockMessage;
...
public class WindowReplaceBlock extends Window implements ButtonHandler
{
    ...
    public void onButtonClicked(@NotNull final Button button)
    {
        if (button.getID().equals(BUTTON_DONE))
        {
            ...
            {
                CopyPaste.getNetwork().sendToServer(new ReplaceBlockMessage(pos1, pos2, from, to));
