...
import com.copypaste.api.util.ItemStackUtils;
import com.copypaste.api.util.ItemStorage;
import com.copypaste.api.util.constant.Constants;
import com.copypaste.blockout.Color;
import com.copypaste.blockout.Pane;
import com.copypaste.blockout.controls.Button;
import com.copypaste.blockout.controls.ItemIcon;
import com.copypaste.blockout.controls.Label;
import com.copypaste.blockout.controls.TextField;
import com.copypaste.blockout.views.ScrollingList;
import com.copypaste.coremod.CopyPaste;
import com.copypaste.coremod.network.messages.RemoveBlockMessage;
import com.copypaste.coremod.network.messages.RemoveEntityMessage;
import com.copypaste.coremod.network.messages.ScanOnServerMessage;
...
public class WindowScan extends AbstractWindowSkeleton
{
    ...
    private void removeEntity(final Button button)
    {
        ...
        CopyPaste.getNetwork().sendToServer(new RemoveEntityMessage(new BlockPos(x1, y1, z1), new BlockPos(x2, y2, z2), entity.getName()));
    ...
    private void removeBlock(final Button button)
    {
        ...
        CopyPaste.getNetwork().sendToServer(new RemoveBlockMessage(new BlockPos(x1, y1, z1), new BlockPos(x2, y2, z2), stack));
    ...
    private void confirmClicked()
    {
        ...
        CopyPaste.getNetwork().sendToServer(new ScanOnServerMessage(new BlockPos(x1, y1, z1), new BlockPos(x2, y2, z2), name));
        Settings.instance.setBox(null);
        close();
    }
