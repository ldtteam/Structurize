...
import com.copypaste.coremod.client.gui.WindowScan;
import com.copypaste.coremod.creativetab.ModCreativeTabs;
import com.copypaste.coremod.network.messages.SaveScanMessage;
...
import static com.copypaste.api.util.constant.Constants.MAX_SCHEMATIC_SIZE;
import static com.copypaste.api.util.constant.NbtTagConstants.FIRST_POS_STRING;
import static com.copypaste.api.util.constant.NbtTagConstants.SECOND_POS_STRING;
import static com.copypaste.api.util.constant.TranslationConstants.MAX_SCHEMATIC_SIZE_REACHED;
...
public class ItemScanTool extends AbstractItemCopyPaste
{
    ...
    public static void saveStructure(@Nullable final World world, @Nullable final BlockPos from, @Nullable final BlockPos to, @NotNull final EntityPlayer player, final String name)
    {
        ...
        final String prefix = "/copypaste/scans/";
