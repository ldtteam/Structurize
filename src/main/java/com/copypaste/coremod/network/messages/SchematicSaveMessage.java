package com.copypaste.coremod.network.messages;
...
import static com.copypaste.api.util.constant.Constants.MAX_AMOUNT_OF_PIECES;
...
public class SchematicSaveMessage extends AbstractMessage<SchematicSaveMessage, IMessage>
{
    ...
    {
        if (!CopyPaste.isClient() && !Configurations.gameplay.allowPlayerSchematics)
        {
