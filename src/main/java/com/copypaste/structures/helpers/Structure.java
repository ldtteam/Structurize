...
import static com.copypaste.api.util.constant.Suppression.RESOURCES_SHOULD_BE_CLOSED;
...
public class Structure
{
    ...
    public static InputStream getStream(final String structureName)
    {
        ...
        else
        {
            ...
            inputstream = Structure.getStreamFromFolder(CopyPaste.proxy.getSchematicsFolder(), structureName);
