...
public class BlockBrickStairs extends AbstractBlockStructurizeStairs<BlockBrickStairs>
{
    ...
    public BlockBrickStairs(final String modelName)
    {
        ...
        /**
         * Gets its block properties from the (structurize-added)
         * beige bricks instead of (vanilla) brick stairs. This
         * is because `AbstractBlockStructurizeStairs` isn't set
         * up to accept properties from a vanilla block and I'm
         * too lazy to change it. This should work fine.
         * It's also how `BlockCactusStair.java` works.
         * (Beige bricks were chosen randomly, but brown or
         * cream bricks would also work.)
         */
