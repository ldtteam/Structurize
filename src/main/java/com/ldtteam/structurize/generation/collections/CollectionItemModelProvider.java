...
public class CollectionItemModelProvider extends ItemModelProvider
{
    ...
    public CollectionItemModelProvider(final DataGenerator gen, final String modid, final ExistingFileHelper exFileHelper, List<RegistryObject<Block>> collection, String textureDirectory)
    {
