...
public class ShinglesItemModelProvider extends AbstractItemModelProvider
{
    ...
    public void act(@NotNull DirectoryCache cache) throws IOException
    {
        ...
        {
            setModelParent(modelJson, new ResourceLocation("structurize:block/shingle/straight/" + shingle.getWoodType().getName() + "/" + shingle.getFaceType().getName() + "_shingle"));
