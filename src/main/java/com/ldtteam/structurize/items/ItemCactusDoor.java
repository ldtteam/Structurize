...
public class ItemCactusDoor extends Item
{
    ...
    ItemCactusDoor(final Block block, final String name)
    {
        ...
        this.setCreativeTab(ModCreativeTabs.STRUCTURIZE);

    }

    @Override
    public EnumActionResult onItemUse(PlayerEntity player, World worldIn, BlockPos pos, EnumHand hand, final EnumFacing facing, float hitX, float hitY, float hitZ)
    {
