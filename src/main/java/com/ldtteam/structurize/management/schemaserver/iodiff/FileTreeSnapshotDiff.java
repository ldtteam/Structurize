...
public class FileTreeSnapshotDiff extends ForwardingList<FileTreeSnapshotDiff.Diff>
{
    private final List<Diff> delegate;
    private final int[] counters;

    private FileTreeSnapshotDiff(final ImmutableList<Diff> delegate, final int[] counters)
    {
    ...
    public static class Builder
    {
        ...
        public FileTreeSnapshotDiff build()
        {
            return new FileTreeSnapshotDiff(builder.build(), counters);
        }
    }
