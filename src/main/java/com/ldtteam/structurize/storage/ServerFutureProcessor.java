...
public class ServerFutureProcessor
{
    ...
    public static void onWorldTick(final TickEvent.WorldTickEvent event)
    {
        ...
        {
            if (!blueprintConsumerQueue.isEmpty() && blueprintConsumerQueue.peek().level == event.world && blueprintConsumerQueue.peek().blueprintFuture.isDone())
            {
            ...
            if (!blueprintDataConsumerQueue.isEmpty() && blueprintDataConsumerQueue.peek().level == event.world && blueprintDataConsumerQueue.peek().blueprintDataFuture.isDone())
            {
