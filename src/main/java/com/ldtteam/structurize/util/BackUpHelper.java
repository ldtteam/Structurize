...
public final class BackUpHelper
{
    ...
    {
        @NotNull final File file = getSaveLocation(FILENAME_LINKSESSION);
        @NotNull final NBTTagCompound data = loadNBTFromPath(file);
    ...
    {
        return new File(DimensionManager.getWorld(0).getSaveHandler().getWorldDirectory(), FILENAME_STRUCTURIZE_PATH);
    }
